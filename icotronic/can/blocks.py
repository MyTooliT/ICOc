...
class UnknownBlockErrorCommandError(Exception):
...
class Block(CANIdPart):
    ...
    def __getitem__(self, block_command: int | str) -> CANIdPart:
        ...
        UnknownBlockErrorCommandError if the
        ...
        Traceback (most recent call last):
            ...
        UnknownBlockErrorCommandError: Unknown block command: “-1”
        ...
        try:
            ...
            raise UnknownBlockErrorCommandError(
