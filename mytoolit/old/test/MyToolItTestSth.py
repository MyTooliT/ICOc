...
class TestSth(unittest.TestCase):
    ...
    def test0015PowerConsumptionEnergySaveMode2(self):
        ...
        try:
            ...
            pass
        self.Can.BlueToothEnergyModeNr(SleepTime["Min"],
                                       SleepTime["AdvertisementReset2"], 1)
        self.Can.BlueToothEnergyModeNr(SleepTime["Reset2"],
                                       SleepTime["AdvertisementReset2"], 2)
        self.Can.bBlueToothDisconnect(MyToolItNetworkNr["STU1"])
        time.sleep(2 + SleepTime["Min"] / 1000)
    ...
    def test0300GetSingleVoltageBattery(self):
        ...
        [val1, val2,
         val3] = self.Can.singleValueArray(MyToolItNetworkNr["STH1"],
                                           MyToolItStreaming["Voltage"], 1, 0,
                                           0, index)
        self.Can.ValueLog(val1, val2, val3, fVoltageBattery, "Battery Voltage",
                          "V")
    ...
    def test0301GetSingleVoltageBatteryMultipleTimes(self):
        ...
        for _i in range(0, 10):
            ...
            [val1, val2,
             val3] = self.Can.singleValueArray(MyToolItNetworkNr["STH1"],
                                               MyToolItStreaming["Voltage"], 1,
                                               0, 0, index)
            self.Can.ValueLog(val1, val2, val3, fVoltageBattery,
                              "Battery Voltage", "V")
            self.singleValueCompare(val1, val2, val3,
                                    self.tSthLimits.uBatteryMiddle,
    ...
    def test0309GetSingleAccXZ(self):
        ...
        self.singleValueCompare(val1, val2, val3,
                                self.tSthLimits.iAdcAccXMiddle,
                                self.tSthLimits.iAdcAccXTolerance, 0, 0,
                                self.tSthLimits.iAdcAccZMiddle,
                                self.tSthLimits.iAdcAccZTolerance,
                                self.tSthLimits.fAcceleration)
    ...
    def test0310GetSingleAccXYZ(self):
        ...
        self.singleValueCompare(
            val1, val2, val3, self.tSthLimits.iAdcAccXMiddle,
    ...
    def test0322GetStreamingAccY(self):
        ...
        self.streamingValueCompare(array1, array2, array3, 0, 2**32,
                                   self.tSthLimits.iAdcAccYMiddle,
    ...
    def test0323GetStreamingAccZ(self):
        ...
        self.streamingValueCompare(array1, array2, array3, 0, 2**32, 0, 2**32,
                                   self.tSthLimits.iAdcAccZMiddle,
                                   self.tSthLimits.iAdcAccZTolerance,
                                   self.tSthLimits.fAcceleration)
    ...
    def test0330SignalIndicatorsAccX(self):
        ...
        [SigIndAccXVar, SigIndAccXSkewness,
         SigIndAccXSNR] = self.tSthLimits.auAccXStatisticsMoment()
        self.siginalIndicatorCheck("ADC X", statistics["Value1"], SigIndAccXQ1,
                                   SigIndAccXQ25, SigIndAccXMedL,
                                   SigIndAccXMedH, SigIndAccXQ75,
    ...
    def test0331SignalIndicatorsAccY(self):
        ...
        [
            ...
            SigIndAccYQ75, SigIndAccYQ99
        ] = self.tSthLimits.auAccYStatisticsHist()
        [SigIndAccYVar, SigIndAccYSkewness,
         SigIndAccYSNR] = self.tSthLimits.auAccYStatisticsMoment()
    ...
    def test0332SignalIndicatorsAccZ(self):
        ...
        [
            ...
            SigIndAccZQ75, SigIndAccZQ99
        ] = self.tSthLimits.auAccZStatisticsHist()
        [SigIndAccZVar, SigIndAccZSkewness,
         SigIndAccZSNR] = self.tSthLimits.auAccZStatisticsMoment()
        self.siginalIndicatorCheck("ADC Z", statistics["Value3"], SigIndAccZQ1,
                                   SigIndAccZQ25, SigIndAccZMedL,
    ...
    def test0333SignalIndicatorsBattery(self):
        ...
        statistics = self.Can.signalIndicators(array1, array2, array3)
        [
            SigIndBatteryQ1, SigIndBatteryQ25, SigIndBatteryMedL,
            SigIndBatteryMedH, SigIndBatteryQ75, SigIndBatteryQ99
        ] = self.tSthLimits.auAccZStatisticsHist()
        [SigIndBatteryVar, SigIndBatterySkewness,
         SigIndBatterySNR] = self.tSthLimits.auAccZStatisticsMoment()
        self.siginalIndicatorCheck("Battery", statistics["Value1"],
                                   SigIndBatteryQ1, SigIndBatteryQ25,
                                   SigIndBatteryMedL, SigIndBatteryMedH,
                                   SigIndBatteryQ75, SigIndBatteryQ99,
                                   SigIndBatteryVar, SigIndBatterySkewness,
                                   SigIndBatterySNR)
    ...
    def test0339MixedStreamingAccXVoltBat(self):
        ...
        time.sleep(1)
        countDel = 0
        while self.tSthLimits.uStandardTestTimeMs < self.Can.getReadMessageTimeMs(
        ...
        self.streamingValueCompare(arrayBat, array2, array3,
                                   self.tSthLimits.uBatteryMiddle,
                                   self.tSthLimits.uBatteryTolerance, 0, 0, 0,
                                   0, fVoltageBattery)
        self.streamingValueCompare(arrayAccX, array2, array3,
                                   self.tSthLimits.iAdcAccXMiddle,
                                   self.tSthLimits.iAdcAccXTolerance, 0, 0, 0,
                                   0, self.tSthLimits.fAcceleration)
    ...
    def test0341MixedStreamingAccYVoltBat(self):
        ...
        self.streamingValueCompare(arrayBat, array2, array3,
                                   ...
                                   self.tSthLimits.uBatteryTolerance, 0, 0, 0,
                                   0, fVoltageBattery)
        self.streamingValueCompare(array1, arrayAccY, array3, 0, 0,
                                   self.tSthLimits.iAdcAccYMiddle,
                                   self.tSthLimits.iAdcAccYTolerance, 0, 0,
                                   self.tSthLimits.fAcceleration)
    ...
    def test0342MixedStreamingAccZVoltBat(self):
        ...
        self.streamingValueCompare(arrayBat, array2, array3,
                                   ...
                                   self.tSthLimits.uBatteryTolerance, 0, 0, 0,
                                   0, fVoltageBattery)
        self.streamingValueCompare(array1, array2, arrayAccZ, 0, 0, 0, 0,
                                   self.tSthLimits.iAdcAccZMiddle,
                                   self.tSthLimits.iAdcAccZTolerance,
                                   self.tSthLimits.fAcceleration)
    ...
    def test0343MixedStreamingAccXZVoltBat(self):
        ...
        self.streamingValueCompare(arrayBat, array2, array3,
                                   ...
                                   self.tSthLimits.uBatteryTolerance, 0, 0, 0,
                                   0, fVoltageBattery)
        self.streamingValueCompare(arrayAccX, array2, arrayAccZ,
                                   self.tSthLimits.iAdcAccXMiddle,
                                   self.tSthLimits.iAdcAccXTolerance, 0, 0,
                                   self.tSthLimits.iAdcAccZMiddle,
                                   self.tSthLimits.iAdcAccZTolerance,
    ...
    def test0344MixedStreamingAccXYVoltBat(self):
        ...
        self.streamingValueCompare(arrayBat, array2, array3,
                                   ...
                                   self.tSthLimits.uBatteryTolerance, 0, 0, 0,
                                   0, fVoltageBattery)
        self.streamingValueCompare(arrayAccX, arrayAccY, array3,
                                   self.tSthLimits.iAdcAccXMiddle,
                                   self.tSthLimits.iAdcAccXTolerance,
                                   self.tSthLimits.iAdcAccYMiddle,
                                   self.tSthLimits.iAdcAccYTolerance, 0, 0,
    ...
    def test0345MixedStreamingAccYZVoltBat(self):
        ...
        self.streamingValueCompare(arrayBat, array2, array3,
                                   ...
                                   self.tSthLimits.uBatteryTolerance, 0, 0, 0,
                                   0, fVoltageBattery)
        self.streamingValueCompare(array1, arrayAccY, arrayAccZ, 0, 0,
                                   self.tSthLimits.iAdcAccYMiddle,
                                   self.tSthLimits.iAdcAccYTolerance,
                                   self.tSthLimits.iAdcAccZMiddle,
                                   self.tSthLimits.iAdcAccZTolerance,
    ...
    def test0346MixedStreamingAccXYZVoltBat(self):
        ...
        self.streamingValueCompare(arrayBat, array2, array3,
                                   ...
                                   0, fVoltageBattery)
        self.streamingValueCompare(
            arrayAccX, array2, arrayAccZ, self.tSthLimits.iAdcAccXMiddle,
            self.tSthLimits.iAdcAccXTolerance, self.tSthLimits.iAdcAccYMiddle,
            self.tSthLimits.iAdcAccYTolerance, self.tSthLimits.iAdcAccZMiddle,
            self.tSthLimits.iAdcAccZTolerance, self.tSthLimits.fAcceleration)
    ...
    def test0347StreamingAccXSingleBattery(self):
        ...
        self.Can.singleValueCollect(MyToolItNetworkNr["STH1"],
                                    MyToolItStreaming["Voltage"], 1, 0, 0)
        time.sleep(9)
        indexEnd = self.Can.GetReadArrayIndex()
        self.Can.streamingStop(MyToolItNetworkNr["STH1"],
                               MyToolItStreaming["Acceleration"])
    ...
    def test0380GetStreamingTestLineAccX(self):
        ...
        self.streamingValueCompare(array1, array2, array3, 2**15, 0, 0, 0, 0,
                                   0, fAdcRawDat)
        [indexStart, indexEnd] = self.streamingTestSignalCollect(
            MyToolItNetworkNr["SPU1"], MyToolItNetworkNr["STH1"],
            MyToolItStreaming["Acceleration"], TestCommandSignal["Line"],
    ...
    def test0381GetStreamingTestLineAccY(self):
        ...
        self.streamingValueCompare(array1, array2, array3, 0, 0, 2**15, 0, 0,
                                   0, fAdcRawDat)
        [indexStart, indexEnd] = self.streamingTestSignalCollect(
            MyToolItNetworkNr["SPU1"], MyToolItNetworkNr["STH1"],
            MyToolItStreaming["Acceleration"], TestCommandSignal["Line"],
    ...
    def test0382GetStreamingTestLineAccZ(self):
        ...
        self.streamingValueCompare(array1, array2, array3, 0, 0, 0, 0, 2**15,
                                   0, fAdcRawDat)
        [indexStart, indexEnd] = self.streamingTestSignalCollect(
            MyToolItNetworkNr["SPU1"], MyToolItNetworkNr["STH1"],
            MyToolItStreaming["Acceleration"], TestCommandSignal["Line"],
    ...
    def test0508AdcConfigSingle(self):
        ...
        for acquisitionTimeKey, acquisitionTimeValue in AdcAcquisitionTime.items(
            ...
            for overSamplingKey, overSamplingVal in AdcOverSamplingRate.items(
                ...
                samplingRate = int(
                    calcSamplingRate(prescaler, acquisitionTimeValue,
                                     overSamplingVal))
                if self.tSthLimits.uSamplingRateSingleMax(
                    ...
                    for _vRefkey, vRefVal in AdcReference.items():
                        result = self.SamplingRate(prescaler,
                    ...
                    self.assertGreaterEqual(
                        samplingRate, self.tSthLimits.uSamplingToleranceLow *
                        result["SamplingRate"])
    ...
    def test0518AdcSamplingRateOverdrive(self):
        ...
        Settings = self.Can.ConfigAdc(MyToolItNetworkNr["STH1"], prescaler,
                                      acquisitionTime, overSamplingRate,
                                      AdcReference["VDD"])[1:]
        self.assertEqual(prescaler, Settings[0])
        self.assertEqual(acquisitionTime, Settings[1])
        self.assertEqual(overSamplingRate, Settings[2])
    ...
    def test0520SamplingRateMixedStreamingAccXYBat(self):
        ...
        time.sleep(1)
        countDel = 0
        while self.tSthLimits.uStandardTestTimeMs + 0.25 < self.Can.getReadMessageTimeMs(
                indexStart, indexEnd) - 0.5:
            countDel += 1
            indexEnd -= 1
        self.Can.Logger.Info("Deleted Messages do achieve " +
    ...
    def test0533MessageCounterBattery(self):
        ...
        [arrayBattery, array2,
         array3] = self.Can.streamingValueArrayMessageCounters(
             MyToolItNetworkNr["STH1"], MyToolItStreaming["Voltage"],
             DataSets[3], 1, 0, 0, indexStart, indexEnd)
        self.Can.ValueLog(arrayBattery, array2, array3, fAdcRawDat,
                          "BatteryMsgCounter", "")
    ...
    def test0600CalibrationMeasurement(self):
        ...
        self.assertGreaterEqual(
            self.tSthLimits.iAdcAccXRawMiddle +
            self.tSthLimits.iAdcAccXTolerance, result)
        ret = self.Can.calibMeasurement(MyToolItNetworkNr["STH1"],
                                        CalibMeassurementActionNr["Measure"],
    ...
    def test0603CalibrationMeasurementEjectInject(self):
        ...
        if 1 < iSensorAxis:
            self.assertGreaterEqual(difKY,
                                    self.tSthLimits.iSelfTestOutputChangemVMin)
            self.assertLowerEqual(difKY,
                                  self.tSthLimits.iSelfTestOutputChangemVTyp)
            self.assertGreaterEqual(difKZ,
                                    self.tSthLimits.iSelfTestOutputChangemVMin)
            self.assertLowerEqual(difKZ,
                                  self.tSthLimits.iSelfTestOutputChangemVTyp)
        # Inject State Check
    ...
    def test0902WrongSenderSth1(self):
        for numberKey, numberVal in MyToolItNetworkNr.items():
            if "SPU1" != numberKey:
                cmd = self.Can.CanCmd(MyToolItBlock["System"],
                                      MyToolItSystem["Reset"], 1, 0)
                message = self.Can.CanMessage20(cmd, numberVal,
                                                MyToolItNetworkNr["STH1"], [])
                msgAck = self.Can.tWriteFrameWaitAckRetries(message,
                                                            waitMs=1000,
                                                            retries=3,
