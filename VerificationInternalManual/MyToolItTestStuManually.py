...
class TestSthManually(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.Can = CanFd.CanFd(self.fileName, self.fileNameError, MyToolItNetworkNr["SPU1"], MyToolItNetworkNr["STH1"])
    ...
    def testManually0700PowerOnOffCounter(self):
        ...
        self.Can.Logger.Info("Power On Counter since first Power On: " + str(PowerOn1))
        self.Can.Logger.Info("Power Off Counter since first Power On: " + str(PowerOff1))
        ...
        self.Can.Logger.Info("Power On Counter since first Power On: " + str(PowerOn2))
        self.Can.Logger.Info("Power Off Counter since first Power On: " + str(PowerOff2))
